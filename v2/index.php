...
<head>
    ...
    <title>Valentin CHEVREAU - Étudiant à HÉTIC - Bachelor Web 3ème année</title>
    <!-- Google Font -->
	            ...
	            <nav class="navbar navbar-default navbar-fixed-top">
	              <div class="container">
	                ...
	                <div class="navbar-header">
	                  ...
	                  <a class="navbar-brand" href="#"><!--<img src="images/logo.png" alt="">-->Valentin CHEVREAU</a>
	                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4  wow fadeInRight animated">
                    <p class="about_us_p">Je m'appelle Valentin CHEVREAU, et j'ai 20 ans. Je suis étudiant en deuxième année de DUT Métiers du Multimédia et de l'Internet. Je prépare ce diplôme à l'IUT DE BLOIS. J'effectue celui-ci en apprentissage chez NEW MOTORZ, entreprise spécialisée dans la commercialisation de véhicules de loisirs (Quad, Scooter...)</p>
                </div>
                <div class="col-md-4  wow fadeInRight animated">
                    <p class="about_us_p">Pour l'année scolaire 2017/2018, je suis admis chez HÉTIC, une grande école de l'Internet de MONTREUIL, en région parisienne. À ce titre, je recherche une entreprise pour m'accueillir en contrat de professionalisation pour ma troisième année en BACHELOR WEB.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-3  wow fadeInLeft animated">
                    ...
                    <div class="single_contact_info">
                        ...
                        <p>contact@valentinchevreau.fr</p>
                    </div><!--
                    <div class="single_contact_info">
                        <h2>Addresse</h2>
                ...
                <div class="col-md-9  wow fadeInRight animated">
                    <form class="contact-form" action="">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control" id="message" rows="25" cols="10" placeholder="Texte du message"></textarea>
                                <button type="button" class="btn btn-default submit-btn form_submit">ENVOYER LE MESSAGE</button>                                
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="copyright_text   wow fadeInUp animated">
                        <p>&copy; Valentin CHEVREAU 2017. Tous droits réservés<a href="http://www.themeforest.net/user/thecodecafe"target="_blank"></a></p>
